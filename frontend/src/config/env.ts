...
export const ENV: EnvironmentConfig = {
  ...
  // In production, use relative URLs (proxied by Vercel serverless function)
...
export const API = {
  ...
  intel: {
    ...
    // PERFORMANCE FIX: Lightweight realtime batch endpoint (80-120MB vs 700-900MB)
    realtimeBatch: (symbols: string[]) => `${ENV.INTEL_API_URL}/api/realtime/batch?symbols=${symbols.join(',')}`,
