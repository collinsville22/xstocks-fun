...
ALLOWED_ORIGINS="${ALLOWED_ORIGINS:-https://xstocksfun.vercel.app,http://localhost:3000,http://localhost:3007}"
...
PYTHONUNBUFFERED=1
EOF
    log_info "Environment file created with ALLOWED_ORIGINS=$ALLOWED_ORIGINS"
